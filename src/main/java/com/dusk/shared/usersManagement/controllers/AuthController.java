...
import com.dusk.shared.commons.miscellaneous.FieldValidation;
import com.dusk.shared.commons.models.JwtResponse;
import com.dusk.shared.commons.models.VerificationCode;
import com.dusk.shared.commons.services.VerificationCodeService;
import com.dusk.shared.usersManagement.models.*;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestParam(name = "code") Integer code,
        ...
        if(!verificationCodeService.isCodeCorrect(email, code) && !verificationCodeService.isCodeStillValid(code))
            return ResponseEntity
                    .badRequest()
    ...
    public ResponseEntity<?> registerUser(
        ...
        if(!verificationCodeService.isCodeCorrect(signupRequest.getEmail(), code) &&
            !verificationCodeService.isCodeStillValid(code))
            return ResponseEntity
                    .badRequest()
                    .body("The verification code is not correct/valid");
        ...
        user.setEncrypted_password(encoder.encode(signupRequest.getPassword()));
        ...
        enterprise.setName("");
        enterprise.setUser(addedUser);
        userService.createEnterprise(enterprise);
